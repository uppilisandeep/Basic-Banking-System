...
$sql = "CREATE DATABASE BankOfVizag";
mysqli_query($conn, $sql);

mysqli_close($conn); 

$conn = mysqli_connect($servername,$dBUsername,$dBPassword,"BankOfVizag");
...
$sql1 = "INSERT INTO e_bankusers (Account_Number,Username,Email_id,password,Balance) VALUES
